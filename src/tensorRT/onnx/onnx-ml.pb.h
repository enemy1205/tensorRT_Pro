...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_onnx_2dml_2eproto3;
namespace onnx {
...
extern QuantInfoDefaultTypeInternal _QuantInfo_default_instance_;
...
template<> ::onnx::QuantInfo* Arena::CreateMaybeMessage<::onnx::QuantInfo>(Arena*);
...
class AttributeProto PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_onnx_2dml_2eproto3.file_level_metadata[kIndexInFileMessages];
  }
...
class QuantInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:onnx.QuantInfo) */ {
 public:
  inline QuantInfo() : QuantInfo(nullptr) {}
  virtual ~QuantInfo();

  QuantInfo(const QuantInfo& from);
  QuantInfo(QuantInfo&& from) noexcept
    : QuantInfo() {
    *this = ::std::move(from);
  }

  inline QuantInfo& operator=(const QuantInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline QuantInfo& operator=(QuantInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const QuantInfo& default_instance();

  static inline const QuantInfo* internal_default_instance() {
    return reinterpret_cast<const QuantInfo*>(
               &_QuantInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(QuantInfo& a, QuantInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(QuantInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(QuantInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline QuantInfo* New() const final {
    return CreateMaybeMessage<QuantInfo>(nullptr);
  }

  QuantInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<QuantInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const QuantInfo& from);
  void MergeFrom(const QuantInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(QuantInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "onnx.QuantInfo";
  }
  protected:
  explicit QuantInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class GraphProto PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kQuantizationAnnotationFieldNumber = 100,
    kNameFieldNumber = 2,
  ...
  ::onnx::QuantInfo* mutable_quantization_annotation(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::QuantInfo >*
      mutable_quantization_annotation();
  private:
  const ::onnx::QuantInfo& _internal_quantization_annotation(int index) const;
  ::onnx::QuantInfo* _internal_add_quantization_annotation();
  public:
  const ::onnx::QuantInfo& quantization_annotation(int index) const;
  ::onnx::QuantInfo* add_quantization_annotation();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::QuantInfo >&
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::QuantInfo > quantization_annotation_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr doc_string_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_onnx_2dml_2eproto3;
...
// string tensor_name = 1;
inline void QuantInfo::clear_tensor_name() {
  tensor_name_.ClearToEmpty();
}
inline const std::string& QuantInfo::tensor_name() const {
  // @@protoc_insertion_point(field_get:onnx.QuantInfo.tensor_name)
  return _internal_tensor_name();
}
inline void QuantInfo::set_tensor_name(const std::string& value) {
  _internal_set_tensor_name(value);
  // @@protoc_insertion_point(field_set:onnx.QuantInfo.tensor_name)
}
inline std::string* QuantInfo::mutable_tensor_name() {
  // @@protoc_insertion_point(field_mutable:onnx.QuantInfo.tensor_name)
  return _internal_mutable_tensor_name();
}
inline const std::string& QuantInfo::_internal_tensor_name() const {
  return tensor_name_.Get();
}
inline void QuantInfo::_internal_set_tensor_name(const std::string& value) {
  
  tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void QuantInfo::set_tensor_name(std::string&& value) {
  
  tensor_name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:onnx.QuantInfo.tensor_name)
}
inline void QuantInfo::set_tensor_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:onnx.QuantInfo.tensor_name)
}
inline void QuantInfo::set_tensor_name(const char* value,
    size_t size) {
  ...
  tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:onnx.QuantInfo.tensor_name)
}
inline std::string* QuantInfo::_internal_mutable_tensor_name() {
  
  return tensor_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* QuantInfo::release_tensor_name() {
  // @@protoc_insertion_point(field_release:onnx.QuantInfo.tensor_name)
  return tensor_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void QuantInfo::set_allocated_tensor_name(std::string* tensor_name) {
  ...
  tensor_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), tensor_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:onnx.QuantInfo.tensor_name)
}

// repeated .onnx.StringStringEntryProto quant_parameter_tensor_names = 2;
inline int QuantInfo::_internal_quant_parameter_tensor_names_size() const {
  return quant_parameter_tensor_names_.size();
}
inline int QuantInfo::quant_parameter_tensor_names_size() const {
  return _internal_quant_parameter_tensor_names_size();
}
inline void QuantInfo::clear_quant_parameter_tensor_names() {
  quant_parameter_tensor_names_.Clear();
}
inline ::onnx::StringStringEntryProto* QuantInfo::mutable_quant_parameter_tensor_names(int index) {
  // @@protoc_insertion_point(field_mutable:onnx.QuantInfo.quant_parameter_tensor_names)
  return quant_parameter_tensor_names_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::StringStringEntryProto >*
QuantInfo::mutable_quant_parameter_tensor_names() {
  // @@protoc_insertion_point(field_mutable_list:onnx.QuantInfo.quant_parameter_tensor_names)
  return &quant_parameter_tensor_names_;
}
inline const ::onnx::StringStringEntryProto& QuantInfo::_internal_quant_parameter_tensor_names(int index) const {
  return quant_parameter_tensor_names_.Get(index);
}
inline const ::onnx::StringStringEntryProto& QuantInfo::quant_parameter_tensor_names(int index) const {
  // @@protoc_insertion_point(field_get:onnx.QuantInfo.quant_parameter_tensor_names)
  return _internal_quant_parameter_tensor_names(index);
}
inline ::onnx::StringStringEntryProto* QuantInfo::_internal_add_quant_parameter_tensor_names() {
  return quant_parameter_tensor_names_.Add();
}
inline ::onnx::StringStringEntryProto* QuantInfo::add_quant_parameter_tensor_names() {
  // @@protoc_insertion_point(field_add:onnx.QuantInfo.quant_parameter_tensor_names)
  return _internal_add_quant_parameter_tensor_names();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::StringStringEntryProto >&
QuantInfo::quant_parameter_tensor_names() const {
  // @@protoc_insertion_point(field_list:onnx.QuantInfo.quant_parameter_tensor_names)
  return quant_parameter_tensor_names_;
}
...
inline ::onnx::QuantInfo* GraphProto::mutable_quantization_annotation(int index) {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::QuantInfo >*
...
inline const ::onnx::QuantInfo& GraphProto::_internal_quantization_annotation(int index) const {
  return quantization_annotation_.Get(index);
}
inline const ::onnx::QuantInfo& GraphProto::quantization_annotation(int index) const {
  // @@protoc_insertion_point(field_get:onnx.GraphProto.quantization_annotation)
  return _internal_quantization_annotation(index);
}
inline ::onnx::QuantInfo* GraphProto::_internal_add_quantization_annotation() {
  return quantization_annotation_.Add();
}
inline ::onnx::QuantInfo* GraphProto::add_quantization_annotation() {
  // @@protoc_insertion_point(field_add:onnx.GraphProto.quantization_annotation)
  return _internal_add_quantization_annotation();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::onnx::QuantInfo >&
